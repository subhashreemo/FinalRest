...
public class BOService {
	...
	public boolean saveBean(BOHeaderBean bean) {
		...
		try{
			...
			validweek=datehandler.getvalidnumberOfweek(bean.getValidFrom(),bean.getValidTo());
			...
			if(validweek==true)
			{
				...
				validweek=false;
				System.out.println("Invalid date validweek is "+validweek);
			}
		}
		catch(Exception e){
			e.printStackTrace();
		}
		System.out.println("Before return "+validweek);
		return validweek;
	}
